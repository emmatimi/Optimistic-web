            ...
            <Section>
                <div className="grid md:grid-cols-5 gap-12 items-center">
                    ...
                    <div className="md:col-span-2">
                        <img src="https://ik.imagekit.io/4lndq5ke52/images/about-image.jpg?q=80&w=500&auto=format&fit=crop" alt="Founder with natural ingredients" className="rounded-lg shadow-xl" />
                    </div>
                </div>
            </Section>
            ...
            <Section>
                 <div className="grid md:grid-cols-5 gap-12 items-center">
                      <div className="md:col-span-2 md:order-first">
                        <img src="https://ik.imagekit.io/4lndq5ke52/images/1752880279421.jpg?q=80&w=500&auto=format&fit=crop" alt="Natural oil product with leaves" className="rounded-lg shadow-xl" />
                    </div>
                    <div className="md:col-span-3">
