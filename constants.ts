...
export const TESTIMONIALS: Testimonial[] = [
    {
        ...
        quote: 'Optimistics Naturals has completely transformed my hair. The Neem Oil is truly nice! My hair is thicker and healthier than ever.',
    ...
    },
    {
        ...
        name: 'Michael B.',
        location: 'Austin, TX',
        quote: 'I was skeptical about face oils, but the coconut oil is a game-changer. My skin feels hydrated, and my acne scars are fading.',
...
export const GALLERY_IMAGES: GalleryImage[] = [
    {
      id: 1,
      beforeUrl: 'https://img.buzzfeed.com/buzzfeed-static/static/2019-04/18/12/asset/buzzfeed-prod-web-06/sub-buzz-14233-1555605036-1.jpg?q=80&w=400&auto=format&fit=crop',
      // afterUrl: 'https://img.buzzfeed.com/buzzfeed-static/static/2019-04/18/12/asset/buzzfeed-prod-web-06/sub-buzz-14233-1555605036-1.jpg?q=80&w=400&auto=format&fit=crop',
      description: '3 months of using Neem Oil',
      afterUrl: ''
    },
    {
      id: 2,
      beforeUrl: 'https://img.buzzfeed.com/buzzfeed-static/static/2019-04/19/9/asset/buzzfeed-prod-web-02/sub-buzz-25099-1555682099-1.jpg?q=80&w=400&auto=format&fit=crop',
      // afterUrl: 'https://images.unsplash.com/photo-1611094054625-f09b52a1c0b3?q=80&w=400&auto=format&fit=crop',
      description: '6 weeks of using coconut oil',
      afterUrl: ''
    },
    {
      id: 3,
      beforeUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQdu3JDk0JptY0NhperSnXAse2yHKegCx21sQ&s?q=80&w=400&auto=format&fit=crop',
     ...
     {
       id: 4,
       beforeUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTVXFZ2vj1u9IE2JUlxIKVTiGsxrwxG1JDwKw&s?q=80&w=400&auto=format&fit=crop',
